    ...
    def setUp(self):
        match_data = {'mapId': 11,
                      ...
                      'participantIdentities': [{'participantId': 1,
                                                ...
                                                {'participantId': 2,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA/40738378',
                                                            'profileIcon': 657,
                                                            'summonerId': 26055342,
                                                            'summonerName': 'PleaseDontBann'}},
                                                {'participantId': 3,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA1/215880437',
                                                            'profileIcon': 6,
                                                            'summonerId': 53106253,
                                                            'summonerName': 'cactusbanana'}},
                                                {'participantId': 4,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA1/206407943',
                                                            'profileIcon': 752,
                                                            'summonerId': 43853345,
                                                            'summonerName': 'ISIDEARMI'}},
                                                {'participantId': 5,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA/326712',
                                                            'profileIcon': 580,
                                                            'summonerId': 299878,
                                                            'summonerName': 'Ronfar'}},
                                                {'participantId': 6,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA1/50462392',
                                                            'profileIcon': 7,
                                                            'summonerId': 35768227,
                                                            'summonerName': 'smellerby14'}},
                                                {'participantId': 7,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA/35195198',
                                                            'profileIcon': 28,
                                                            'summonerId': 21699840,
                                                            'summonerName': 'Evilxw'}},
                                                {'participantId': 8,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA/39584133',
                                                            'profileIcon': 691,
                                                            'summonerId': 25063569,
                                                            'summonerName': 'FBG Hoe'}},
                                                {'participantId': 9,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA1/203896113',
                                                            'profileIcon': 745,
                                                            'summonerId': 40951562,
                                                            'summonerName': 'TqashPKM'}},
                                                {'participantId': 10,
                                                 'player': {'matchHistoryUri': '/v1/stats/player_history/NA1/203417104',
                                                            'profileIcon': 786,
                                                            'summonerId': 40299020,
                      ...
                      'participants': [{'championId': 154,
                                       ...
                                       {'championId': 31,
                                        ...
                                        'timeline': {'creepsPerMinDeltas': {'tenToTwenty': 4.8,
                                                     ...
                                                     'damageTakenDiffPerMinDeltas': {'tenToTwenty': 617.0999999999999,
                                       ...
                                       {'championId': 16,
                                        ...
                                        'timeline': {'creepsPerMinDeltas': {'tenToTwenty': 0.2,
                                                     ...
                                                     'csDiffPerMinDeltas': {'tenToTwenty': -0.6999999999999995,
                                                                            ...
                                                                            'zeroToTen': -0.25},
                                                     'damageTakenDiffPerMinDeltas': {'tenToTwenty': -224.45000000000005,
        ...
        self.match = MatchDetail.objects.create_match(match_data)
...
class BannedChampionTestCase(TestMatchModels):
    def test_create(self):
        ...
        self.assertTrue(created.pick_turn == 2)
...
class TeamTestCase(TestMatchModels):
    def test_create_without_bans(self):
        ...
        self.assertTrue(created.tower_kills == 4)
...
class ParticipantTest(TestMatchModels):
    def test_create_without_runes_and_masteries(self):
        ...
        self.assertTrue(created.champion_id == 154)
...
class ParticipantIdentityTest(TestMatchModels):
    def test_create(self):
        ...
        self.assertTrue(created.match_detail == self.match)
...
class MasteryTest(TestMatchModels):
    def test_create(self):
        ...
        self.assertTrue(created.rank == 1)
...
class ParticipantTimelineTest(TestMatchModels):
    def test_create(self):
        ...
        self.assertTrue(created.role == 'NONE')
...
class RuneTest(TestMatchModels):
    def test_create(self):
        ...
        self.assertTrue(created.rune_id == 5273)
