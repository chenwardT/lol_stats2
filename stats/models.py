...
class ChampionStats(models.Model):
    ...
    sum_total_damage_dealt = models.BigIntegerField(blank=True, null=True)
    avg_total_damage_dealt = models.FloatField(blank=True, null=True)
    sum_total_damage_taken = models.BigIntegerField(blank=True, null=True)
    avg_total_damage_taken = models.FloatField(blank=True, null=True)
    # Double-check these for self vs all healing
    sum_total_heal = models.BigIntegerField(blank=True, null=True)
    avg_total_heal = models.FloatField(blank=True, null=True)
